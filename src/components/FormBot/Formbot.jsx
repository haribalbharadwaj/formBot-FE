...
const Formbot = () => {
    ...
    const renderInput = (input, index) => {
        ...
        switch (type) {
            ...
            case 'textInputs':
                return (
                    <div key={id} style={{left:'25%',height:'7%',top:'12%',background:'#508C9B',fontFamily:'Open Sans,sans-serif',
                    fontSize:'15px',fontWeight:'600',lineHeight:'20.43px',textAlign: 'left'}}>
